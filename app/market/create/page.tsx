...
const sectors = [
  {
    id: "mobility-heavy",
    title: "Automotive, Trucks & RVs & Equipment",
    description: "Commercial vehicles, RVs, and heavy-duty logistics intake.",
    icon: Car,
...
function IntakeContent() {
  ...
  const handleNavigation = (id: string) => {
    // 🛡️ BAZARIA SHELL LEVEL INTERLOCK
    if (id === "mobility" || id === "mobility-heavy") {
      window.location.href = "/market/create/mobility";
      return;
    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ marginTop: '80px', textAlign: 'center', opacity: '0.4' }}>
          <p style={{ fontSize: '9px', fontWeight: '900', textTransform: 'uppercase', letterSpacing: '0.5em', color: '#014d4e' }}>
