...
export default function SanctuaryCaribbeanCreate() {
  ...
  const [formData, setFormData] = useState({
    title: "",
    propertyType: "Oceanfront Villa", // Oceanfront Villa, International Estate, Boutique Hotel, Luxury Suite
    location: "",
    bedrooms: "",
    bathrooms: "",
    lotSize: "", // Square Meters (m2)
    price: "",
    saleMode: "Auction",
    durationDays: "30", // Real estate usually needs 30-day discovery
    reservePrice: "",
    startingBid: "",
    description: "",
          ...
          <form onSubmit={handleSubmit} className="p-12 space-y-10">
           ...
           {/* SECTION: ESTATE IDENTITY & LOCATION */}
            ...
            <div style={{ textAlign: 'left' }} className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest text-slate-400">Estate Description</label>
              <textarea 
                rows={4}
                placeholder="Highlight ocean views, private beach access, security protocols, and luxury amenities..."
            ...
            <div className="space-y-6 bg-slate-50 p-8 rounded-[2rem] border-2 border-slate-100">
              <div style={{ textAlign: 'left' }} className="flex justify-between items-center">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400">Bidding Window</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div style={{ textAlign: 'left' }} className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-teal-600 italic">Starting Bid (USD)</label>
            ...
            <div style={{ textAlign: 'left' }} className="space-y-4 bg-slate-900 p-8 rounded-[2rem] border-2 border-slate-800 text-white">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 style={{ color: '#fbbf24', margin: '0' }} className="text-[11px] font-black uppercase tracking-widest italic">International Audit Protocol</h3>
                  <div className="mt-4 space-y-3">
                    <p className="text-[10px] font-bold text-slate-400 m-0 leading-relaxed uppercase">
                      1. Title verification and international lien search required for Caribbean assets.
                    </p>
                    <p className="text-[10px] font-bold text-slate-400 m-0 leading-relaxed uppercase">
                      2. Withdrawal after bid initiation results in permanent listing suspension.
                    </p>
                  </div>
                </div>
              </div>
              <label className="flex items-center gap-3 bg-white/5 p-5 rounded-xl border border-white/10 cursor-pointer hover:bg-white/10 transition-colors">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-200">Acknowledge International Audit Protocol</span>
              </label>
            </div>
