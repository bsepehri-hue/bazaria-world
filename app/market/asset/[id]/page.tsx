...
{/* 💰 BID/CHECKOUT MODAL: BULLETPROOF RENDER */}
      <div 
        className={`fixed inset-0 z-[99999] flex items-center justify-center p-4 transition-all duration-300 ${
          isBidModalOpen ? 'opacity-100 pointer-events-auto bg-slate-900/80 backdrop-blur-sm' : 'opacity-0 pointer-events-none'
        }`}
      >
        {isBidModalOpen && (
          <div className="w-full max-w-md">
            ...
            {paymentMethod === null ? (
              <div className="bg-white rounded-3xl p-8 w-full text-center shadow-2xl border border-slate-200 transform transition-all">
              ...
              /* RAIL 3: CRYPTO FORM */
              <div className="bg-white rounded-3xl p-8 w-full shadow-2xl border border-slate-200 flex flex-col transform transition-all">
