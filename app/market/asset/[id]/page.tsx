      ...
      {mounted && isBidModalOpen && createPortal(
        ...
        >
          ...
          {paymentMethod === null ? (
            ...
            /* RAIL 3: CRYPTO FORM */
            <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl border border-slate-200 flex flex-col" style={{ color: '#0f172a' }} onClick={(e) => e.stopPropagation()}>
