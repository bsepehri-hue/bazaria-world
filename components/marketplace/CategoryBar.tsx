      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', width: '100%', alignItems: 'center' }}>
        {MARKET_CATEGORIES.map((cat, index) => (
          <div 
            ...
            style={{ position: 'relative', flexShrink: 0 }} // 🟢 BACK TO RELATIVE
          >
            <button
            ...
            {openCategory === cat.id && cat.subcategories && (
              <div 
                style={{ 
                  ...
                  /* ⚖️ THE "SMART ANCHOR" */
                  /* 1. First 2 buttons: Align to the left edge of button */
                  /* 2. Last 3 buttons: Align to the right edge of button */
                  /* 3. Middle: Center it */
